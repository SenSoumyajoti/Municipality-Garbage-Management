                ...
                ? <div>
                    ...
                    <div className="dashboardContainer min-h-[calc(100vh-4rem)] flex flex-col justify-between items-center px-6">
                        <div className="flex flex-col gap-6 justify-center items-center h-[45vh]">
                            ...
                            <button className="inline-block w-48 bg-green-700 py-2 font-medium text-white rounded-full">Request Collection</button>
                        </div>
                        <div className="grid gap-5 w-[85vw]
                                        grid-cols-3">
                            <CardsComponent icon={faTruckFast} heading={"Quick Collection"} message={"Schedule a pickup at your preffered time"} />
                            <CardsComponent icon={faLocationDot} heading={"Location Tracking"} message={"Track your daily collection status"} />
                            <CardsComponent icon={faRegularStar} heading={'Service Feedback'} message={"Help us improve with your feedback"} />
                        </div>
