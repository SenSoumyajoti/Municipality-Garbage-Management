                ...
                <div className="relative p-10 pb-7 mt-16" style={{boxShadow: "10px 10px 20px 4px rgb(0 0 0 / 0.1), -10px -10px 20px 4px rgb(0 0 0 / 0.1)"}}>
                    ...
                    <form className="flex flex-col items-center">
                        <div className="grid grid-cols-2 gap-20">
                            <div className="flex flex-col gap-7">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="feedbackOptions p-2 text-lg border-2 border-gray-300 rounded-sm flex gap-10">
                                        <div>
                                            <input type="radio" value="yes" id="cleanedYes" name="isCleaned" />
                                            <label htmlFor="cleanedYes">Yes</label>
                                        </div>
                                        <div>
                                            <input type="radio" value="no" id="cleanedNo" name="isCleaned" />
                            ...
                            <div className="flex flex-col gap-7">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="feedbackOptions p-2 text-lg border-2 border-gray-300 rounded-sm flex gap-10">
                                        <div>
                                            <input type="radio" value="yes" id="arrivedYes"/>
                                            <label htmlFor="arrivedYes">Yes</label>
                                        </div>
                                        <div>
                                            <input type="radio" value="no" id="arrivedNo"/>
                        ...
                        <div className="mt-7 w-full">
                            ...
                            <textarea name="" id="" className="feedbackOptions p-1 bg-gray-200 rounded-sm w-full h-32 mt-2"></textarea>
                        </div>
